        ...
        <div class="card-body">
            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
              ...
              <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">English Name</th>
              ...
              <tbody>
                ...
                @foreach ($squads as $sq)
                    <tr class="odd">
                        <td width="500">{{$sq->id}}</td>
                        <td width="700">{{$sq->name_ar}}</td>
                        <td width="700">{{$sq->name_en}}</td>
                        <td width="300"><a href="{{route('admin.squads.delete',$sq->id)}}" class="btn btn-block btn-danger">Delete</a></td>
                    </tr>
                @endforeach
                @endisset
              </tbody>
              <div class="card-header">
                <a href="{{route('admin.squads.create')}}" class="btn btn-success">Add Squad</a>
